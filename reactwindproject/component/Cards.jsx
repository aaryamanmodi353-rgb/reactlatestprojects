...
import screenshot from ""; //paste the url of the image


        


function Cards({channel,btnText = "click"}) {
  const [count, setCount] = useState(0);


  //necessary things always have a compatible tailwind version
  //using card in tailwind

//this will give the username since props is a object
//we can directly use username by using brace


//this username will we displayed in the output
    ...
    <>
      <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:scale-105 group">
        <div className="relative overflow-hidden rounded-lg mb-6">
          <img
            src={screenshot}  // OR use the random pic below
